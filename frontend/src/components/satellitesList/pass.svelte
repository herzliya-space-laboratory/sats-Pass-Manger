...
<tr class="flex w-full mb-4">
    <td class="w-1/6 px-6 py-4 whitespace-no-wrap">
    ...
    <td class="w-1/6 px-6 text-center py-4 whitespace-no-wrap">
        {@html new Date(pass.endTime).toLocaleString().replace(',', '<br>')}
    </td>

    <td class="w-1/6 px-6 text-center py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
    ...
    <td class="w-1/6 px-6 py-4 whitespace-no-wrap text-center text-sm leading-5 font-medium">
